...
Let me login to hub docker, search - jetty, if you do not have a account yet, pleae create one because docker push need login dicker hub first.
...
you can see all these options  and I   show you now
...
- docker image inspect myjetty:v1clar
...
I hope  now you can use docker image basice command in you project. 
